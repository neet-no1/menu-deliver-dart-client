...
class AccountApi {
  ...
  ///
  /// Parameters:
  /// * [oneTimePassword] - メールアドレスの有効性確認パスワード
  ...
  Future<Response<BasicResponse>> emailConfirm({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'oneTimePassword': encodeQueryParameter(_serializers, oneTimePassword, const FullType(String)),
    };
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AccountAuthResponse>> getAccountAuth({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _responseType = FullType(AccountAuthResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AccountResponse>> getAccountInfo({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _responseType = FullType(AccountResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as AccountResponse;
  ...
  /// Returns a [Future] containing a [Response] with a [BasicResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BasicResponse>> registAccount({ 
    required RegistAccountParam registAccountParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RegistAccountParam);
      _bodyData = _serializers.serialize(registAccountParam, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BasicResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BasicResponse>> resetPassword({ 
  ...
  /// Returns a [Future] containing a [Response] with a [BasicResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BasicResponse>> updateAccountInfo({ 
    required String name,
    required String email,
    required MultipartFile icon,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/account/info/update';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BasicResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BasicResponse>> updatePassword({ 
    required UpdatePasswordParam updatePasswordParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/account/password/update';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdatePasswordParam);
      _bodyData = _serializers.serialize(updatePasswordParam, specifiedType: _type);
