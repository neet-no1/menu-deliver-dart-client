...
class QuestionsResponse {
  ...
  @override
  String toString() => 'QuestionsResponse[info=$info, code=$code, errorInfo=$errorInfo]';
  ...
  static List<QuestionsResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(QuestionsResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <QuestionsResponse>[];
  ...
  static Map<String, QuestionsResponse> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = QuestionsResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of QuestionsResponse-objects as value to a dart map
  static Map<String, List<QuestionsResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<QuestionsResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = QuestionsResponse.listFromJson(
            value,
